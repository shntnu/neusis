{
  ...
  inputs = {
    ...
    # A newer nixos-unstable used only for karkinos's ollama: Qwen3.8 needs ollama >= 0.32.12,
    ...
    # rshen's personal Home Manager config. Consumed by
    # homes/rshen/machines/oppy.nix via `homeModules.rshen-agents`;
