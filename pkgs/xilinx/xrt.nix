...
stdenv.mkDerivation rec {
  ...
  preConfigure = ''
    ...
    export CP_FIRMWARE_DIR=$(pwd)/root/lib/firmware/xilinx
  ...
  postInstall = ''
    ...
    mkdir -p $out/opt/xilinx/firmware
    cp -r $CP_FIRMWARE_DIR  $out/opt/xilinx/firmware
    ln -s $out/opt/xilinx/firmware $out/opt/xilinx/xrt/share/fw
  '';
