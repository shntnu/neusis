{
  ...
  src = requireFile {
    name = "sst_1.11.268-0_amd64.deb";
    url = "https://solidigm.com/";
    message = "Download the deb file from official website";
    sha256 = "1slcvj68zbpwr7f5blqyjqlz5rj4and5ck90wzf40aycbn1n4xfa";
  };
in
  stdenv.mkDerivation {
    pname = "sst";
